...
<div class="container">
   <div class="panel panel-default">
        <div class="panel-heading">
                <h2><i class="fa fa-handshake-o" aria-hidden="true"></i>&nbsp;KAMPONG THOM</h2>
                                                       <ul class="ul-detail">
                    <li>
            ...
            <div class="container">
                      ...
                      class="img-fluid"></li>
                            ...
                            <div class="bs-example bs-example-tabs example-tabs mb-5" style="margin-top:90px;">
                                <ul id="myTab" class="nav nav-tabs">
                                    <li class="active"><a href="#vehicle" data-toggle="tab">Hotel & Guesthouse Overview</a></li>
                                </ul>
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                        <table width="100%" class="mb-5">
                                           ...
                                           <tr>
                                <td>Ref No.:</td>
                                <td align="right" style="color:red;">KGT-KTH-0001</td>

                            </tr>                 
                                                            
                            <tr>
                                <td>HOTEL NAME.:</td>
                                <td align="right" style="color:red;">KAMPONG THOM</td>

                            </tr>
                           
                            <tr>
                                <td>LOCATION:</td>
                                <td align="right">Phsar Leu</td>
                            </tr>

                            <tr>
                                <td>PHONE:</td>
                                <td align="right">012 914 517</td>
                            </tr>
                            <tr>
                                <td>WEBSITE:</td>
                                <td align="right"><a target="_blank" href="http://www.GraceTrading">www.GraceTrading</a></td>
                                </tr>
                            <tr>
                                <td>DISTANCE FROM CITY	:</td>
                                <td align="right">30Km</td>
                                </tr>
                            <tr>
                                <td>DETAIL:</td>
                                <td align="right"></td>
...
<div class="container mb-3">
    <h4 class="mb-2 mt-5" style="color: white; border-radius: 5px; padding-left: 10px; text-transform: uppercase; background-color: #ff0505">
            ...
            <a htef="">
            <div class="item">
              <h5 style="background:#000;color:#fff;text-align:center">KAMPONG THOM</h5>
              <img src="http://choicecart.xyz/bootstrap_old/system/admin/image/hotel/20190724_9734.png">
              <div class="btn-div">
              <button class="btn btn-default view_btn">VIEW Nº OF HOTEL</button>
              </div>
            </div>
            </a>
         <a htef="">
