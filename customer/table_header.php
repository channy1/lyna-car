...
<body class="bg-light p-5">
  <section class=" mt-20" >   
    <div class="demo  mt-20 w-80 h-50 mx-auto bg-success text-center rounded">
        <div  ><h1 class="text-center  text-light p-5 rounded ">You are not able to access this page, Please </h1></div>
         <a class="btn btn-primary mb-2 text-white " href="<?php echo $base_url; ?>customer_login.php">Login Here...</a> 
