...
if(isset($_POST["btn_search_pickupdropoff"]) || isset($_POST["btn_select_data"]) ) {
  $_SESSION['txt_pick_up_location']=@$connect->real_escape_string($_POST['txt_pick_up_location']);
  $_SESSION['txt_drop_off']=@$connect->real_escape_string($_POST['txt_drop_off']);
 

  $_SESSION['txt_trip_way']=@$connect->real_escape_string($_POST['txt_trip_way']);
  $_SESSION['txt_time_pickup']=@$connect->real_escape_string($_POST['txt_time_pickup']);
  $_SESSION['txt_depareture_date']=@$connect->real_escape_string($_POST['txt_depareture_date']);
  $_SESSION['txt_time_pickup']=@$connect->real_escape_string($_POST['txt_time_pickup']);
}

if(isset($_POST['btn_search_pickupdropoff'])) {
  $_SESSION['txt_pickup_map']=@$connect->real_escape_string($_POST['txt_pickup_map']);
  $_SESSION['txt_return_map']=@$connect->real_escape_string($_POST['txt_return_map']);
...
<div class="tabbable-panel margin-tops4">
			      ...
			      <ul class="nav nav-tabs tabtop  tabsetting" id="myTab" role="tablist">
			       ...
			       <div class="tab-content" id="myTabContent" style="margin-top:30px;">
			          ...
			          <div class="tab-pane <?php if(empty($post_step)) {echo "in active";} ?>" id="one">
                                            <form action="pickup_order.php" method="POST" class="booking-form">
                                            <div class="row">
     ...
     <option data-display="Vehicle Type">Select Vehicle Type</option>
			          ...
			          <div class="tab-pane <?php if($post_step=="1") {echo "active in";} ?>" id="two"<?php if($post_step=="1") { ?> id="two" <?php } ?> >
			          	...
			          	<form method="post" action="pickup_order.php" id="form_car" class="booking-form">
                    ...
                    <input type="hidden" name="post_step" value="2">
                        ...
                        <button style="margin-top: 10px;" id="btn_car" class="btn btn-success gauto-theme-btn" name="btn_car" type="submit">Continue</button>
                        <label id="check_car"></label>
                        <?php
                                $pro_id_from="";
                                $sql_province ="SELECT pro_from_id FROM tbl_pickup_drop_off 
                                                 WHERE tbl_pickup_drop_off.air_id='$txt_pick_up_location'
                                 ";
                                ...
                                $pro_id_to="";
                                $sql_to ="SELECT pro_to_id FROM tbl_pickup_drop_off 
                                                 WHERE tbl_pickup_drop_off.air_id='$txt_drop_off'
                                 ";
                                 ...
                                 $sql ="SELECT *
                                        FROM tbl_pickup_drop_off 
                                        LEFT JOIN tbl_vehicle_rantal  ON tbl_pickup_drop_off.car_id = tbl_vehicle_rantal.ve_id
                                        LEFT JOIN tbl_province        ON tbl_province.pv_id = tbl_pickup_drop_off.pro_from_id
                                        WHERE tbl_pickup_drop_off.pro_from_id='$pro_id_from' AND tbl_pickup_drop_off.pro_to_id='$pro_id_to' GROUP BY tbl_vehicle_rantal.ve_id
                                        ...
                                        <table class="table table-borderless" style="width:50%;float:right;">
                                         ...
                                         <tbody>
                                           <tr>
                                             ...
                                             <td>$<?php echo number_format($row['round_trip'],2); ?></td>
                                           </tr>
                                           <tr>
    ...
    <?php
        ...
        <div class="col-md-12">
            ...
            <form method="post" action="pickup_order.php" class="booking-form">
                <input type="hidden" name="post_step" value="2">
                ...
                <div class="form-group">
                    <button type="submit" name="btn_login" class="btn btn-success gauto-theme-btn" value="Login" />Login</button>
                </div>
                <div class="form-group">
        ...
        <?php } else { ?>
            ...
            <form action="pickup_order.php" method="post" id="agree_form" style="padding: 24px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="my-dropdown make-dropdown">
                            ...
                            <button type="submit" id="c_agree" class="btn btn-primary gauto-theme-btn" name="term_condiction">Continue</button>
                        </div>
            ...
            <script type="text/javascript">
                function checkAgree() {
			     ...
			     <div class="tab-pane <?php if($post_step=="3") {echo "active in";} ?>"id="four" id="four" <?php if($post_step=="3") { ?> id="four"<?php  } ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      ?>
                                                      <?php
                                                  echo  $_SESSION["txt_depareture_date"].' '. $_SESSION["txt_time_pickup"];
                                                      ?>                                                            
                                                   </td> 
                                 ...
                                 <tr style="text-align: center">
                                     ...
                                     <th style="background-color:#ec3323;color:white" class="aa text-center" width="8%" nowrap="nowrap">Amount</th>
                                         ...
                                         <?php
                                          $v_sql_from = "SELECT pro_from_id FROM tbl_pickup_drop_off where air_id='$txt_pick_up_location'  ";
                                             $result = $connect->query($v_sql_from);
                                             if ($result->num_rows > 0) {
                                             while($row = $result->fetch_assoc()) {
                                              $item_pro_from=$row['pro_from_id'];
                                            }
                                          }
                                          $v_sql_from = "SELECT pro_to_id FROM tbl_pickup_drop_off where air_id='$txt_drop_off'  ";
                                             $result = $connect->query($v_sql_from);
                                             if ($result->num_rows > 0) {
                                             while($row = $result->fetch_assoc()) {
                                              $item_pro_to_id=$row['pro_to_id'];
                                            }
                                          }
                                             ...
                                             $car_id=""; 
                                             $sql ="SELECT * FROM tbl_vehicle_rantal INNER JOIN tbl_pickup_drop_off   
                                           ON tbl_vehicle_rantal.ve_id = tbl_pickup_drop_off.car_id
                                           ...
                                           WHERE ve_id='' GROUP BY car_id";
                                              ...
                                              $car_id=$_SESSION['car_id'];
                                              $sql ="SELECT * FROM tbl_vehicle_rantal LEFT JOIN tbl_pickup_drop_off   
                                           ON tbl_vehicle_rantal.ve_id = tbl_pickup_drop_off.car_id
                                           WHERE  ve_id IN ($car_id) 

                                           AND pro_from_id='$item_pro_from' AND pro_to_id='$item_pro_to_id'  GROUP BY car_id
                                           ";
                                             ...
                                             $vat_confirm=0;
                                             $i=1;
                                             $trip_way=$_SESSION['txt_trip_way'];
                                             ...
                                             while($row = $result->fetch_assoc()){
                                               $vat_confirm=$row['vat'];
                                                 ...
                                                 $total_discount=$price_confirm-($price_confirm * $discount_check)/100;
                                                 $total_amount=($total_discount)+($total_discount * $vat_confirm)/100; 
                                       ...
                                       <tr style="height:25px;border:1px!important">                                                                                                     
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="right" style="text-align:right;width:8%;background:#ffffff;border:1px solid #000000;" nowrap="">$<?php
                                      ...
                                      <td align="right" style="background:#ffffff;border:1px solid #000000;" nowrap="">$<?php echo number_format($total_rental,2);  ?></td>
                                  </tr>
                                   <tr style="height:25px;border:1px!important">
                                      <td></td>
                                      <td></td>
                                  ...
                                  <tr>
                                      ...
                                      <td align="right" style="background:#ec3323;border:1px solid #000000;;color:white;font-weight:900;" nowrap="">$<?php echo $_SESSION['total_amount']= number_format($total_service_char + $total_rental,2); ?></td>
                                  </tr>
                                  ...
                                  <tr>
                                      ...
                                      <td style="white-space: nowrap;" class="aa" colspan="3">&nbsp;</td>
                                      <td style="font-weight: 800;text-align: right;color:white;padding-right: 10px" class="aa">&nbsp;</td>
                                  </tr>
            ...
            <div class="aba-modal-content">
               ...
               <form method="POST" target="aba_webservice" action="<?php echo PayWayApiCheckout::getApiUrl(); ?>" id="aba_merchant_request">
                <?php
                     ...
                     $continue_success_url ='http://'.$_SERVER['SERVER_NAME'].'/'.'lyna-CarRental/pickup_order.php?tranid='.$transactionId;
                  ...
                  $pick_up_location=$_SESSION['txt_pick_up_location'];
                  $drop_location=$_SESSION['txt_drop_off'];
                  $amount_web_pay=$total_service_char + $total_rental;
                  $txt_trip_way=@$_SESSION['txt_trip_way'];
                  $departur_time=@$_SESSION['txt_time_pickup'];
                  $departur_date=@$_SESSION['txt_depareture_date'];
                  $today = date("Y-m-d");
                  $txt_pickup_map=$_SESSION['txt_pickup_map'];
                  $return_map=$_SESSION['txt_return_map'];
                  $get_url_tran_id=$connect->real_escape_string(@$_GET['tranid']);
                  if( ($get_url_tran_id !="") && ($_SESSION["term_check_pay"]) !="" ) {
                  if($result['status'] ==0){
                     $sql = "INSERT INTO `tbl_pickup_booking`(
                            `user_id`,
                            `pick_up_location`,
                            `drop_location`,
                            `booking_date`,
                        ...
                        if($connect->query($sql)){
                         ...
                         if ($result->num_rows > 0) {
                           while($row = $result->fetch_assoc()){
                          $vat_in=$row['vat'];
                          if($_SESSION['txt_trip_way']=="1") {
                            $discount_check=$row['discount_one'];
                            $price_check=$row['one_way'];

                          }
                          elseif ($_SESSION['txt_trip_way']=="2") {
                            $discount_check=$row['discount_two'];
                             $price_check=$row['round_trip'];
                          }
                          else {
                            $discount_check=$row['discount_one'];
                             $price_check=$row['one_way'];
                           ...
                           $sql_driver = "INSERT INTO `tbl_pickup_book_car`(
                            `booking_id`,
                            `car_id`,
                            `price`,
                            `discount`,
                  ...
                  <table width="100%" align="left" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial;font-size:12px">
                    <tbody>
                      ...
                      <tr bgcolor="#ffffff">
                        ...
                        <td width="25%" align="left">'.$_SESSION["txt_depareture_date"].':'.$_SESSION["txt_time_pickup"].'</td>
                                <td width="5%"></td>
                                <td width="20%" align="left"></td>
                                <td width="30%" align="right"></td>
                              </tr>
                        ...
                        <td>
                         ...
                         $htmlContent.='<tr style="height:30px;border:1px solid #000000">
                           ...
                           $htmlContent.='
                              ...
                              <td align="right" style="border:1px solid #000000;width:8%;" nowrap="">$'.number_format($price_confirm,2).'</td>
                              <td align="center" style="text-align:right;padding-left:8px;width:8%;border:1px solid #000000">'.number_format(0,2).'%</td>
                              <td align="right" style="text-align:right;border:1px solid #000000;width:8%;" nowrap="">'.number_format($vat_confirm,2).'%</td>
                              <td align="right" style="text-align:right;border:1px solid #000000;width:8%;" nowrap="">$'.number_format($total_amount,2).'</td>
                              </tr>';
                           ...
                           $htmlContent.='<tr style="height:25px;border:0px!important">
                             ...
                             $htmlContent.='<td align="right" style="text-align:right;border:1px solid #000000;" nowrap="">$'.number_format($total_rental, 2).'</td>
                                      </tr><tr style="height:25px;border:0px!important">
                                      <td align="left" colspan="3" style="border:1px solid #000000;" nowrap="">&nbsp;2. Service Charge (3%):
                                      </td>';
                                      $total_service_char=number_format(($total_rental *3)/100, 2);
                              $htmlContent.='<td align="right" style="text-align:right;border:1px solid #000000;" nowrap="">$'.number_format($total_service_char, 2).'</td>
                                      </tr>';
                                    $paid=$total_service_char + $total_rental;
                                    $htmlContent.='<tr style="height:25px;border:0px!important">
                                      <td align="left" colspan="3" style="border:1px solid #000000;" nowrap="">&nbsp;3. Amount Paid :</td>
                                      <td align="right" style="text-align:right;background:#e6e6e6;border:1px solid #000000;" nowrap="">$'.number_format($paid, 2).'</td>
                                      </tr>
                     ...
                     <table class="table no-border no-margin">
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <?php
                                      if(!isset($_SESSION["txt_time_pickup"]))
                                        {
                                        $_SESSION["txt_time_pickup"]="";
                                         }
                                       else {
                                         $_SESSION["txt_time_pickup"];
                                         }
                           ...
                           <tr>
                            ...
                            <td>
                                <?php
                                      if(!isset($_SESSION["txt_pick_up_location"]))
                                        {
                                         $id=$_SESSION["txt_pick_up_location"]="";
                                         }
                                       else {
                                        $id= $_SESSION["txt_pick_up_location"];
                                         }
                                       
                                 $sql ="SELECT * FROM tbl_pickup_drop_off LEFT JOIN tbl_province 
                                            ON tbl_province.pv_id = tbl_pickup_drop_off.pro_from_id WHERE air_id='$id'";
                                  $result = $connect->query($sql);
                                  if ($result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()){
                                 ?>
                            ...
                            <td>
                               <?php
                                      if(!isset($_SESSION["txt_drop_off"]))
                                        {
                                         $id=$_SESSION["txt_drop_off"]="";
                                         }
                                       else {
                                        $id= $_SESSION["txt_drop_off"];
                                         }
                                 ...
                                 $sql ="SELECT * FROM tbl_pickup_drop_off LEFT JOIN tbl_province 
                                            ON tbl_province.pv_id = tbl_pickup_drop_off.pro_to_id WHERE air_id='$id'";
                                  $result = $connect->query($sql);
                                  if ($result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()){
                                 ?>
                                    ...
                                    <tbody>
                                      <?php
                                       ...
                                       <tr>
                                          ...
                                          elseif ($txt_trip_way=="2") {
                                             $price_check=$row['round_trip'];
                                          }
                                          else {
                                            $price_check=$row['one_way'];
                                          }
                                           echo number_format($price_check,2); 
                                           ?> </td>
                                       </tr>
