...
require '../sidebar.php';
  ...
  $v_sql = "SELECT * FROM tbl_quotation_admin";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CAR RENTAL QUOTATION CONTROL PANEL </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Car Rental Quotation </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                          $delete_url="dalete.php?delete_id=".$row['q_id'];
                          ?>
                          <!-- <?php  $images=$row["pre_image"]; ?>
                             <tr>
                              ...
                              <!--<td><a href="edit.php?edit_id=<?php echo $row['q_id'];?>" class="btn btn-xs  btn-success">Edit</a>
