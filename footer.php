<style>
    ...
    .video-box .play-now{top:58% !important;}
                                ...
                                <div class="single-footer-post">
                                    <div class="footer-post-image">
                                        <a href="info_center_new_detail.php?id=<?php echo $row["info_center_id"]; ?>">
                                            <img src="<?php echo $base_url ?>/system/admin/image/info_center/<?php echo $row["images"]; ?>" />
                                        </a>
                                    </div>
                    ...
                    <div class="single-footer">
                        ...
                        <div class="inner-column">
                            <div class="video-box wow fadeIn">
                                <figure class="image"><img src="<?php echo $base_url ?>/assets/img/blog-3.jpg" alt=""></figure>
