<?php 
  //  session_start();
 $u_possition = $_SESSION['user']->user_position; 
 //print_r($u_possition);
 if(@$_SESSION['user']->user_position !=5){
	 ?>	 
	<!DOCTYPE html>
<html lang="en">
  <head>
...
<body class="bg-light p-5">
  <section class=" mt-20" >   
    <div class="demo w-80 h-50 mx-auto bg-success text-center rounded">
        <div  ><h1 class="text-center  text-light p-5 rounded ">You are not able to access this page, Please </h1></div>
       <a  class="btn btn-primary mb-2 text-white " href="<?php echo $base_url; ?>partner_login.php">Login Here...</a> 
...
<head>
  ...
  <!-- Tell the browseDar to be responsive to screen width -->
