...
$_SESSION["tour_quide_id"]=@$connect->real_escape_string($_POST['identity_driver']);
}
...
<div class="tabbable-panel margin-tops4">
			          ...
			          <ul class="nav nav-tabs tabtop  tabsetting" id="myTab" role="tablist">
			            ...
			            <li <?php if($post_step=="1"){ echo "class='active'"; }?>>
			                <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="false">Select a Tour Guide</a>
			            </li>
			       ...
			       <div class="tab-content" id="myTabContent" style="margin-top:30px;">
			          <div class="tab-pane <?php if(empty($post_step)) {echo "in active";} ?>" id="one">
                                     <form action="tour_quide_rent_booking.php" method="POST" class="booking-form">
                                            <div class="row">
                                                   <div class="col-md-6">
                                                    <p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <p class="m-top-0">
                                                                ...
                                                                <select name="driver_language_id"  required>
                                                ...
                                                <div class="col-md-12">
                                                    <p>
                                                        <button type="submit" name="btn_find_home" class="gauto-theme-btn"><?=(@$_SESSION['lang']=='en')?'Find Tour Guide Now' : 'ស្វែងរករថយន្ត';?></button>
                                                    </p>
                                                </div>
                                            </div>
			          ...
			          <div class="tab-pane <?php if($post_step=="1") {echo "active in";} ?>" id="two" <?php if($post_step=="1") { ?> id="two" <?php } ?> >
			          	<form method="post" action="tour_quide_rent_booking.php" id="form_drive" class="booking-form">
			          	...
			          	<label id="alert_drive"></label>
			          	 <?php 
                                            ...
                                            WHERE  user_position='3' AND user_position_id='7' AND  province_id='$driver_province_id'
                                            ";
    ...
    <?php
        ...
        <div class="col-md-12">
            ...
            <form method="post" action="tour_quide_rent_booking.php" class="booking-form">
                <input type="hidden" name="post_step" value="2">
        ...
        <?php } else { ?>
            ...
            <form action="tour_quide_rent_booking.php" method="post" id="agree_form" style="padding: 24px;">
			     ...
			     <div class="tab-pane <?php if($post_step=="3") {echo "active in";} ?>" id="four" <?php if($post_step=="3") { ?> id="four"<?php  } ?>>
                                 ...
                                 <tbody><tr><td colspan="8" style="border-bottom:1px solid #ccc;text-align: left;background-color:  #ec3323;color:rgb(254, 250, 250);"><strong style="font-size:14px;">&nbsp;Item Information</strong></td></tr>
                                     ...
                                     <th style="background-color:#ec3323;color:white" class="aa text-center" width="8%" nowrap="nowrap">Amount</th>
                                          ...
                                          <?php
                                             ...
                                             while($row = $result->fetch_assoc()){
                                               ...
                                               // holiday calulate
                                                ...
                                                $total_refun_tour_fix +=$refun_tour;
                                       ...
                                       <tr style="height:25px;border:1px!important">                                                                                                     
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="right" style="width:8%;background:#ffffff;border:1px solid #000000;" nowrap="">$<?php
                                      ...
                                      <tr style="height:25px;border:1px!important">                                                                                                     
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          echo number_format($extraday_price_item, 2);?></td>
                                      </tr>
                                      <?php 
                                         }
                                      ?>
                                      ...
                                      <td align="right" style="background:#ffffff;border:1px solid #000000" nowrap="">$<?php echo number_format($total_rental=$amount_tour, 2);  ?></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td align="right" style="background:#ec3323;border:1px solid #000000;color:white;font-weight:900;" nowrap="">&nbsp;$<?php echo number_format($total_service_char + $total_rental, 2); ?></td>
                                  </tr>
                                  <tr>
                                      ...
                                      <?php echo number_format($total_refun_tour, 2); ?>
                                       </td>
                                  </tr>
                                    <tr>
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;5. Due Amount <span style="color:red;">**</span>:</td>
                                      <td align="right" style="background:#ec3323;color:white;font-weight:900;border:1px solid #000000;" nowrap="">$<?php echo number_format($total_refun_tour, 2); ?></td>
                                  </tr>
            ...
            <div class="aba-modal-content">
               ...
               <form method="POST" target="aba_webservice" action="<?php echo PayWayApiCheckout::getApiUrl(); ?>" id="aba_merchant_request">
                <?php
                     ...
                     $continue_success_url ='http://'.$_SERVER['SERVER_NAME'].'/'.'lyna-CarRental/tour_quide_rent_booking.php?tranid='.$transactionId;
  ...
  if(!isset($_SESSION["tour_quide_id"])) {
                         ...
                         $htmlContent.='<tr style="height:30px;border:1px solid #000000">
                           ...
                           $htmlContent.='<td align="center" style="border:1px solid #000000;width:8%">'.$total_day_daily.' Day(s)</td>
                              ...
                              <td align="right" style="border:1px solid #000000;width:5%;" nowrap="">$'.number_format($daily_price_item, 2).'</td>
                              </tr>';
                             ...
                             $htmlContent.='<td align="right" style="border:1px solid #000000;" nowrap="">$'.number_format($total_rental, 2).'</td>
                              ...
                              $htmlContent.='<td align="right" style="border:1px solid #000000;" nowrap="">$'.number_format($total_service_char, 2).'</td>
                                    ...
                                    $htmlContent.='<tr style="height:25px;border:0px!important">
                                      ...
                                      $htmlContent.=' <tr style="height:25px;border:1px!important">
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;4. Refundable Deposit (RD):</td>
                                      <td align="right" style="background:#e6e6e6;border:1px solid #000000;" nowrap="">$'.number_format($total_refun_tour_fix, 2).'
                                       </td>
                                  </tr>';
                                      $htmlContent.='<tr style="height:25px;border:1px!important">
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;5. Due Amount <span style="color:red;">**</span>:</td>
                                      <td align="right" style="background:#e6e6e6;border:1px solid #000000;" nowrap="">$'.number_format($total_refun_tour_fix, 2).'</td>
                                  </tr>';
...
$("#agree_form").submit(function(event) {
 ...
 $("#form_drive").submit(function( event ) {
            ...
            if(alldata==''){
              $("#alert_drive").html("Select Tour Quide Rental");
              return false;
            }
            else{
              return true;
