	...
	<div class="mainDetails">
		<div class="row">
           <div class="col-xs-12">
           	...
           	<p class="text-align:left;" style="font-size: 1.2em;"><?php echo trim(@$_SESSION['user']->user_first_name) ?> <?php echo trim(@$_SESSION['user']->user_last_name) ?></p>
           </div>
           <div class="col-md-8">
           	<ul>
			<li>Address:   <?php echo trim(@$_SESSION['user']->user_address) ?></li>
			<li>E-mail:    <?php echo trim(@$_SESSION['user']->user_email) ?></li>
			<li>Tel:      <?php echo trim(@$_SESSION['user']->user_phone_number) ?></li>
			</ul>
           </div>
		...
		<section>
			<article>
				...
				<div class="sectionContent">
					<ul>
						<li>Sex: <?php echo trim(@$_SESSION['user']->user_gender) ?></li>
						<li>Phone: <?php echo trim(@$_SESSION['user']->user_phone_number) ?></li>
						<li>E-mail: <?php echo trim(@$_SESSION['user']->user_email) ?></li>
						<li>Date of Birth: <?php echo trim(@$_SESSION['user']->user_birthday) ?></li>
