    ...
    <div class="portlet light bordered">
        ...
        <table class="table table-bordered" width="100%">
            <thead>
                ...
                <tr>
                    <th rowspan="0"   style="text-transform: uppercase;vertical-align: top;">Date</th>
                    <th rowspan="0"  style="text-transform: uppercase;vertical-align: top;">ID N&deg;</th>
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">Partner Name</th>
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">Counpon Card N&deg;</th>
                    <th style="text-transform: uppercase;vertical-align: top;" colspan="5">Partner Income
                    </th>
                    <th style="text-transform: uppercase;border-bottom:1px solid #eef1f5 !important;vertical-align: top;">Dis%</th>
                    <th style="text-transform: uppercase;border-bottom:1px solid #eef1f5 !important;vertical-align: top;">Total Income</th>
                    <th style="text-transform: uppercase;vertical-align: top;" colspan="9">Partner Expense
                    </th>
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">Total Expenes</th>
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">Amount Payable</th>
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">No of Use</th>
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">Date Paid Bonus</th> 
                    <th rowspan="0" style="text-transform: uppercase;vertical-align: top;">Partner history Notes</th> 
                        ...
                        while($row = $result->fetch_assoc()){
                          ...
                          ?>
                                  ...
                                  <tr>
                                     ...
                                     <td>
                                     <label style="width:90px; font-size: 9px;">
                                         <?php
                                     ...
                                     <td>
                                   <label style="width:130px;font-size: 9px;">
                                          <?php
