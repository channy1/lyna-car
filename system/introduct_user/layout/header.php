    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-header navbar navbar-fixed-top" style="background-color: #a4509f !important;">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo" style="display: flex; justify-content: spance-bettwen;">
                    <div>
                        <a href="../../../index.php">
                    ...
                    <div class="logo-default" style="margin-top: -2px; margin-left:-5px; margin-right: 10px;"> 
                        <p class="text-default" style="font-size: 13px; color: white;">លីណាជួលរថយន្តទេសចរណ៍<br>Lyna CarRental.Comdd</p>
                    </div>
        ...
        <div class="page-container">
            ...
            <?php
                ...
                // die($_SESSION['user']->user_position);
                if(@$_SESSION['user']->user_position == 1){
                    include_once(getcwd().'../../dashboard/left_navigation_admin.php'); 
                }else if(@$_SESSION['user']->user_position == 2){
                    include_once(getcwd().'../dashboard/left_navigation_customer.php');
                }else if(@$_SESSION['user']->user_position ==11){
                    include_once(getcwd().'../left_navigation_introducer.php');
                }else{
                    include_once(getcwd().'../dashboard/left_navigation_partner.php');
                }
            ?>
            <!-- END SIDEBAR -->
