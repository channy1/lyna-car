		...
		<header>
			<div class="row">
				...
				<div class="col-sm-6">
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p class="text-right">Welcome to ! <a href="#" class="btn btn-success"><i class="fa fa-database"></i> DATABASE MANAGEMENT SYSTEM</a></p>
				</div>
			</div>
		</header>
	</div>
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<form onsubmit="if(document.getElementById('password').value != document.getElementById('confirm_password').value){alert('password not match'); return false; } " action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" role="form">
						<legend>Register To Enter Group</legend>
						<br>
			...
			<div class="row">
				...
				<div class="col-sm-9">
					<article class="text-right">
						<p>Address: No 13, St 2, Borei Phum Trapeang thloeng, Sangkat Chorm Chao, Khanm Por Sen Chey, Phnom Penh, Cambodia.</p>
						<p>Zip Code: 12000</p>
						<p>Tel: (855) 92 96 33 56 / (855) 98 96 33 56</p>
						<p>Email: <a href="#">Info@entergroupcambodia.com </a></p>
						<p>Website: <a href="http://entergroupcambodia.com">www.entergroupcambodia.com </a></p> 
					</article>
				</div>
