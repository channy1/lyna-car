                    ...
                    <div class="panel-heading">
                        ...
                        <div class="form-group">
                            ...
                            <select name="txt_vechicle_no" class="form-control" >
                                 <option value="">==All Vechicle==</option>
                                <?php 
                                  $get_vechicle_no = $connect->query("SELECT * FROM tbl_vehicle_rantal");
                                  while($row_vechicle_no = mysqli_fetch_object($get_vechicle_no)){
                                      if($row_vechicle_no->ve_id == @$_POST['txt_vechicle_no']){
                                          echo '<option SELECTED value="'.$row_vechicle_no->ve_id.'">'.$row_vechicle_no->ve_ref_no.'</option>';

                                      }else{
                                          echo '<option value="'.$row_vechicle_no->ve_id.'">'.$row_vechicle_no->ve_ref_no.'</option>';
