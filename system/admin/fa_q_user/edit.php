...
<div class="portlet light bordered">
 ...
 <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">កែប្រែការសួរសំនួរ </b></h3>
                <b style="font-size: 20px;">EDIT ASK QUESTIONS</b><br><br>
                        ...
                        <div class="row">
                         <div >
                          <div class="form-group row" style="padding: 15px;">
                                <!-- Material input -->
                                <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="color: white;font-size: 15px;">Questions:</label>
                             ...
                             <div class="form-group row" style="padding: 15px;">
                                <!-- Material input -->
                                <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="color: white;font-size: 15px;">Answers:</label>
                                <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                                  <div class="md-form mt-0">
                             ...
                             <div class="form-group row" style="padding: 15px;">
                                <!-- Material input -->
                                <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="color: white;font-size: 15px;">Order:</label>
                                ...
                                <label for="" class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="color: white;font-size: 15px;">Status:</label>
                                <div class="col-xs-8 col-sm-4 col-md-4 col-lg-4">
                                  <div class="md-form mt-0">
