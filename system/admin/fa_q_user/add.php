    ...
    <div class="portlet-title">
     ...
     <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">ការសួរសំនួរ </b></h3>
                <b style="font-size: 20px;">ASK QUESTIONS/b><br><br>
                         ...
                         <div >
                          <div class="form-group row" style="padding: 15px;">
                             ...
                             <div class="form-group row" style="padding: 15px;">
                                ...
                                <label for="" class="col-xs-4 col-sm-1 col-md-1 col-lg-1" style="color: white; font-size: 15px;">Status:</label>
                                <div class="col-xs-8 col-sm-4 col-md-4 col-lg-4">
                                  <div class="md-form mt-0">
