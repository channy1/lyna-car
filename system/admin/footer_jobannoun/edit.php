...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_ft_job_announ SET ft_title='$v_title',ft_detail='$v_detail' WHERE ft_id='$edit_id'";
...
<?php
    ...
    $query="SELECT * FROM tbl_ft_job_announ WHERE ft_id='$edit_id'";
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួល ការជ្រើសរើសបុគ្គលិក</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT JOB ANNOUNCEMENTS</b><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-md-2 col-sm-2 col-lg-1">Title
