         ...
         <div class="col-sm-12">
            ...
            <div style="width:100%;margin: 0 auto;border:0px solid #ccc;" id="div">
               ...
               <div style="width: 100%;text-align: center;font-size: 18px; font-weight: bold;">
                  <span>TOUR GUIDE RENTAL AGREEMENT</span>
               </div>
               <div style="width: 100%;">
            ...
            <div>
               ...
               <span style="float: right;margin-top: -20px;margin-right: 39px;clear: both;font-size: 8px;"><?php echo $row['ag_ref_no']; ?></span>
                  ...
                  <div style="width: 100%;float: left;margin-top: -5px;">
                     <div style="width: 100%;">
                        <label>IV. Tour Guide's Information</label>
                     </div>
                     <?php
                      $id=$_GET['id'];
                  ...
                  <div style="width: 100%;float: left;margin-top: -2px;">
                     ...
                     <div style="width: 100%;float: left;font-size: 11pxpadding-left: 15px;">
                        <table border="1" style="border-collapse: collapse;width: 99%;font-size: 11px">
                           <tbody>
                              <tr>
                                 <td colspan="2" style="font-weight: bold; text-align: center;padding:6px;width: 25%"><span>Rental Period Information</span></td>
                                 <td style="font-weight: bold; text-align: center;padding:6px;padding:6px;padding:6px;padding:6px;width: 25%"><span>Items Description</span></td>
                                 <td style="font-weight: bold; text-align: center;padding:6px;padding:6px;padding:6px;width: 15%"><span>Unit Price</span></td>
                                 <td style="font-weight: bold; text-align: center;padding:6px;padding:6px;width: 15%"><span>Total Price</span></td>
                                 <td style="font-weight: bold; text-align: center;padding:6px;width: 20%"><span>Remarks</span></td>
                              </tr>
                              <tr>
                                 ...
                                 <td style="padding:1px;">1.  Tour Guide Rental</td>
                  ...
                  <div style="width: 100%;float: left;margin-top: -2px;">
                     ...
                     <div style="width: 100%;float: left;font-size: 11px;">
                        ...
                        <div style="width:28%;float:left;border:1px solid #ccc;margin-left: 8px;height:90px;line-height: 14px;padding: 0.5%;">
                           ...
                           stay or use the Tour Guide, the
