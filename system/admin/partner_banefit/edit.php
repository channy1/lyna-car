...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួលម៉ែនញ</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT MENU</b><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                      <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-2 col-md-2 col-lg-2">Title (En)
                                ...
                                <div class="form-group form-md-line-input">
                                      <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-2 col-md-2 col-lg-2">Title (Kh)
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                                    <span class="help-block">Enter Title...</span>
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                    <input type="text" class="form-control" name="txt_title_kh" placeholder="Enter Title" value="<?php echo ($title_kh); ?>"  required="required" autocomplete="off" style="background-color: white;">
                                  </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    <textarea row="5" class="form-control detail" id="detail" name="txt_detail" placeholder="Repeat your password" required="required" autocomplete="off"><?php echo ($description); ?></textarea>
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    <textarea row="5" class="form-control detail" id="details" name="txt_detail_kh" placeholder="Repeat your password" required="required" autocomplete="off"><?php echo ($v_description_kh); ?></textarea>
