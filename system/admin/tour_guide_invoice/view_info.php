  ...
  <div style="width: 16px; border: 1px solid black;display:inline-block;text-align: center;color: blue;"><label>6</label></div>  
            ...
            <div class="row">
                ...
                <div class="panel-heading" style="width:100%;background: #fff !important;">
                    ...
                    <span style="color: blue;"><label style="font-size: 15px; font-weight: bold;">Tour Guide Rental Service</label></span>
                    </div>
                </div>
            </div>
                  ...
                  $id=$_GET['id'];
                      ...
                      ?>
                        ...
                        <tr style="height:25px;border:1px!important">
                            ...
                            <td align="center" style="color:blue;padding-right: 3px;width:10%;border:1px solid #000000">
                                <label>
                              <?php echo $row_dr['tr_daily_day']; ?> Day(s)</label>
                            </td>
                            ...
                            <td align="right" style="color:blue;padding-right:3px;width:10%;border:1px solid #000000">
                                <label>
                              $<?php echo number_format($row_dr['tr_price_daily'],2); ?></label>
                            </td>

                            <td align="right" style="color:blue;padding-right :3px;width:10%;border:1px solid #000000"><label>
                              <?php echo number_format($row_dr['tr_discount'],2); ?>%</label></td>
                            <td align="right" style="color:blue;padding-right :3px;width:10%;border:1px solid #000000"><label>
                              <?php echo number_format($row_dr['tr_vat'],2); ?>%</label></td>

                            <td align="right" style="color:blue;padding-right :3px;width:10%;border:1px solid #000000"><label>

                             $<?php
                            
                            $total_price_dr_item=$row_dr['tr_amount_daily'];
                         ...
                         $total_extraday="";
                         $total_extraday=0;
                         $total_extraday=$row_dr['tr_extra_day'];
                                        if($total_extraday>0) {
                                      ?>
                                      <tr style="height:25px;border:1px!important">                                                                                                     
                                ...
                                <label><?php echo $total_extraday; ?> Day(s)</label></td>
                                          ...
                                          <td align="right" style="color:blue;padding-right:3px;width:10%;border:1px solid #000000">
                                <label>
                                            $<?php  echo number_format($row_dr['tr_price_extra'], 2); ?></label></td>
                                          ...
                                          <td align="right" style="color:blue;padding-right :3px;width:10%;border:1px solid #000000"><label>
                                            $<?php
                                                 ...
                                                 $total_price_ex_dr_item=$row_dr['tr_amount_extra'];
                                    ...
                                    $total_holiday="";
                                    $total_holiday=0;
                                    $total_holiday=$row_dr['tr_holiday_day'];
                                        if($total_holiday>0) {
                                      ?>
                                      <tr style="height:25px;border:1px!important">                                                                                                     
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                ...
                                <label><?php echo $total_holiday; ?> Day(s)</label></td>
                                          ...
                                          <td align="right" style="color:blue;padding-right:3px;width:10%;border:1px solid #000000">
                                <label>
                                            $<?php  echo number_format($row_dr['tr_price_holiday'], 2); ?></label></td>
                                          ...
                                          <td align="right" style="color:blue;padding-right :3px;width:10%;border:1px solid #000000"><label>
                                            $<?php
                                             ...
                                             $total_holiday_dr_item=$row_dr['tr_amount_holiday'];
            ...
            ?>
                          <td colspan="4" rowspan="6" style="font-size:9px;">
                            ...
                            <td align="right" style="padding-right:3px;color:blue;background:#ffffff;border:1px solid #000000;" nowrap="">&nbsp;
                              <label>$<?php $total_rental=$total_dr;
