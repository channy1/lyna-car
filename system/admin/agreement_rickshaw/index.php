             ...
             <div class="col-lg-5 col-xs-4">
                <div class="row">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Rickshaw Ref. N&deg;</label>
                            <select name="txt_vechicle_no" class="form-control" >
                                 <option value="">==All Rickshaw==</option>
                                <?php 
                                  $get_rick = $connect->query("SELECT  * FROM  tbl_rick_shaw_rental_last ORDER BY ve_title ");
                                  while($row_ric = mysqli_fetch_object($get_rick)){
                                     
                                          echo '<option value="'.$row_ric->ve_id.'">'.$row_ric->ve_ref_no.'</option>';
                 ...
                 <div class="panel panel-default">
                    <div class="panel-heading">
                         <h5 style=" text-transform: capitalize;font-weight: bold;color: #13599c;">IV. Rickshaw Period information</h5>
                         <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
...
$('#txt_period_day').val(daily_day_js+extra_day_js);
$("#txt_extra_day").val(0);
