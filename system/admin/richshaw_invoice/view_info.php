                ...
                <div class="col-xs-7">
                    ...
                    <div class="">
                        <table style="width:100%">
                            <tr>
                                <th style="padding:2px;font-weight: 100;">Grand Total:<label id="gr_total"style="margin-left:5px;color:blue;font-weight:900;font-size:14px;">&nbsp;&nbsp;</label>
                                </th>
                            </tr>
                          <?php
                          $get_id=$_GET['id'];
  ...
  <div style="width: 16px; border: 1px solid black;display:inline-block;text-align: center;color: blue;"><label>6</label></div>  
                ...
                <div class="col-xs-5">
                    ...
                    <fieldset style="border: 1px solid #a4509f; border-radius: 9px;">
                        <legend style="border-bottom:none;margin-bottom:6px; background:none; text-align: left; margin-left: 20px; width:60px; color: #a4509f;">
            ...
            <div class="row">
                ...
                <div class="panel-heading" style="width:100%;background: #fff !important;">
                    ...
                    <span style="color: blue;"><label style="font-size: 15px; font-weight: bold;">Rickshaw Rental Service</label></span>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                       ...
                       <?php
                             ...
                             $query="SELECT * FROM tbl_quotation_admin
                                                LEFT JOIN tbl_quotation_rickshaw
                                                ON tbl_quotation_admin.q_id=tbl_quotation_rickshaw.q_id
                                                LEFT JOIN tbl_rick_shaw_rental_last
                                                ON tbl_rick_shaw_rental_last.ve_id=tbl_quotation_rickshaw.rick_id
                        ...
                        <tr style="height:25px;border:1px!important">
                            ...
                            <td align="left" style="color:blue;padding-left: 8px;width:2%;border:1px solid #000000">
                                <label>
                                <?php echo $row['ve_title']; ?></label> </td>
                            <td align="center" style="color:blue;padding-right: 3px;width:2%;border:1px solid #000000">
                                <label>
                                <?php echo $row['rick_daily_day']; ?> Day(s) </label> </td>
                            <td align="center" style="color:blue;width:2%;border:1px solid #000000"><label>1</label></td>
                            <td align="right" style="color:blue;padding-right:3px;width:2%;border:1px solid #000000">
                                <label>
                                $<?php
                                  echo number_format($row['rick_daily_price'],2);
                                ?>
                              </label>
                            </td>
                            ...
                            <td align="right" style="color:blue;padding-right :3px;width:2%;border:1px solid #000000"><label>
                                <?php
                                if($row['rick_discount'] !="" || $row['rick_discount']=="0"){
                                    $car_dis=$row['rick_discount'];
                                }
                                else {
                                    $car_dis=0;
                                }
                            ...
                            <td align="right" style="color:blue;padding-right:3px;width:2%;border:1px solid #000000">
                                ...
                                <?php
                                if($row['rick_vat'] !="" || $row['rick_vat']=="0"){
                                    $car_vat=$row['rick_vat'];
                                }
                                else {
                                    $car_vat=0;
                                }
                            ...
                            <td align="right" style="color:blue;padding-right:3px;background:#ffffff;border:1px solid #000000;" nowrap="">
                                ...
                                $<?php 
                                 ...
                                 $price_item_car_extra=$row['rick_amount_daily'];
            ...
            ?>
                     ...
                     $sql ="SELECT * FROM tbl_users  
                      ...
                      ?>
                            <td colspan="4" rowspan="5" style="font-size:9px;">
                            ...
                            <td align="right" style="padding-right:3px;color:blue;background:#ffffff;border:1px solid #000000;" nowrap="">&nbsp;
                              <label>&nbsp;
                              $<?php $total_rental=$total_rich+$total_acc+$total_dr+$total_tr;
           ...
           <!--  <div class="row">
            ...
            <div class="row" style="padding: 0;">
                <div class="col-xs-4" style="padding: 0;">
                    ...
                    <br>
                    <label style="float:left;margin-left: 65px; font-size: 14px;">Customer's Signature</label>
                ...
                <div class="col-xs-4" style="padding: 0;">
                    ...
                    <br>
                    <label style="float:left;margin-left: 95px; font-size: 14px;">Prepare By:</label>
                ...
                <div class="col-xs-4" style="padding: 0;">
                    ...
                    <br>
                    <label style="float:left;margin-left: 95px; font-size: 14px;">Approved By:</label>
