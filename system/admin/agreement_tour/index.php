...
<div class="portlet light bordered">
             ...
             <div class="col-lg-5 col-xs-4">
                <div class="row">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Tour Guide Information</label>
                            <select name="txt_vechicle_no" class="form-control" >
                                 <option value="">==All Tour==</option>
                                <?php 
                                  $get_driver = $connect->query("SELECT tbl_province.*,tbl_users.*,tbl_user_position.* FROM tbl_users INNER JOIN tbl_user_position ON tbl_users.user_position=tbl_user_position.up_id 
    ...
    where user_position ='3' and user_position_id='7'  GROUP BY user_id ");
                                  while($row_get_driver = mysqli_fetch_object($get_driver)){
                                     
                                          echo '<option value="'.$row_get_driver->user_id.'">'.$row_get_driver->user_first_name.' '.$row_get_driver->user_last_name.'</option>';
