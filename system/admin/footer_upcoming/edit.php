...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_ft_upcoming SET ft_title='$v_title',ft_detail='$v_detail' WHERE ft_id='$edit_id'";
...
<?php
    ...
    $query="SELECT * FROM tbl_ft_upcoming WHERE ft_id='$edit_id'";
...
<div class="portlet light bordered">
   ...
   <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​កែសម្រួល នាពេលខាងមុខ </b></h3>
                <b style="font-size: 20px;">​​​​​EDIT UPCOMING</b><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-2 col-md-2 col-lg-1">Title
