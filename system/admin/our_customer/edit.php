    ...
    <div class="portlet-title">
     ...
     <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">កែសម្រួល អតិថិជនរបស់យើង</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT OUR CUSTOMER</b><br><br>
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                    <input type="text" class="form-control" name="txt_url" placeholder="Enter Title" value="<?php echo ($url_link); ?>"  required="required" autocomplete="off" style="background-color: white;">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-12 col-md-12 col-lg-2">Image
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                            ...
                            <div class="col-sm-3">
                                <img src="../image/our_customer/<?php echo $image;?>" alt="<?php echo $image; ?>" style="width:100%;height:200px;border:2px solid black; border-radius:5px !important ;">
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
