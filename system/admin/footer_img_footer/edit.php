...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_ft_img_foooter SET ft_title='$v_title',ft_detail='$v_detail' WHERE ft_id='$edit_id'";
...
<?php
    ...
    $query="SELECT * FROM tbl_ft_img_foooter WHERE ft_id='$edit_id'";
    $result = $connect->query($query);
    if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
            $title = $row["ft_title"];
            $description = $row["ft_detail"];
        }
    }
    else{}
?>
    ...
    <div class="portlet-title">
     ...
     <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួលរូបភាព</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT IMAGE FOOTE12</b><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                      <label style="color: white;font-size: 15px" class="col-xs-12 col-md-2 col-sm-2 col-lg-1">Link
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px" class="col-xs-12 col-md-2 col-sm-2 col-lg-1">icon
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                                    <span class="help-block">Enter icon...</span>
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                                    <input type="text" class="form-control" name="txt_detail" placeholder="Enter Icon name" value="<?php echo ($description); ?>"  required="required" autocomplete="off" style="background-color: white;">
                                   </div>
                                </div>
                            </div>
                            <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
