...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms ?>
            <h2><i class="fa fa-edit fa-fw"></i>Edit Record</h2>
        </div>
    </div>
    <br>
    <br>
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
            <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួល ព័ត៌មានថ្ងៃឈប់សំរាក</b></h3>
            <b style="font-size: 20px;">​​​​​EDIT PUBLIC HOLIDAYS</b><br><br>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <input type="text" value="<?php echo $description; ?> " class="form-control" name="txt_description"   autocomplete="off" style="background-color: white;" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <input readonly value="<?php echo $date_holiday; ?>" data-provide="datepicker" data-date-format="yyyy-mm-dd" readonly="" type="text" name="txt_date" class="form-control input-sm emptys" id="datepicker" style="background-color: white;" required>
