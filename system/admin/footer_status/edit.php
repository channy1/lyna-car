...
<?php
   $edit_id = $_GET["edit_id"]; 
    $query="SELECT * FROM tbl_footer_status WHERE footer_id='$edit_id'";
...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_footer_status SET pre_title='$v_title',pre_title_kh='$v_title_kh',pre_detail='$v_detail',pre_detail_kh='$v_detail_kh' WHERE footer_id='$edit_id'";
...
<div class="portlet light bordered">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួល ព័ត៌មានបឋម</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT </b><br><br>
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    <textarea style="height: 290px;" class="form-control detail" id="details" name="txt_detail_kh" placeholder="Repeat your password" required="required" autocomplete="off"><?php echo ($description_kh); ?></textarea>
