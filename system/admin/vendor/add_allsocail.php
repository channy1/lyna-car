                        ...
                        <div class="form-group row" style="padding: 15px;">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                  <div class="md-form mt-0">
                                    ...
                                    <input type="text" value="" name="s_telagram" placeholder="URL Telagram">
                                    <input type="text" value="" name="s_whatapp" placeholder="URL  whatsapp">
                                    <input type="text" value="" name="s_whatapp" placeholder="URL  Wechat">
