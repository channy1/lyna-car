    ...
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                ...
                <b style="font-size: 20px;">​​​​​EDIT PRE_INFORMATION</b><br><br>
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <img src="../image/pre_info/<?php echo $image;?>" alt="<?php echo $image; ?>" style="width:100%;height:200px;border:2px solid black; border-radius:5px !important ;">
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
