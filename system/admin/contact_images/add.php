...
<?php 
    if(isset($_POST['btn_add'])){
            ...
            $v_image1 = $new_name;
            $query_add = "INSERT INTO tbl_contact_images (
                    images,
                    status
                    ) 
                VALUES(
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">បញ្ជូលរូបភាព</b></h3>
                <b style="font-size: 20px;">​ADD IMAGES </b><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                      ...
                                      <label style="color: white;font-size: 15px;" class="col-xs-4 col-sm-2 col-md-2 col-lg-2">Status
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                      <label style="color: white;font-size: 15px;" class="col-xs-7 col-sm-4 col-md-4 col-lg-2">Choose Image
                                        <span class="required" aria-required="true">*</span>
                                    </label>
