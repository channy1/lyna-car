...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">កែសម្រួល ខេត្ត</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT PROVICE</b><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-3 col-md-3 col-lg-2">Title​(En)
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-3 col-md-3 col-lg-2">Title (Kh)
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                                    <span class="help-block">Enter Title...</span>
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-sm-3 col-md-3 col-lg-2">Image
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                            ...
                            <div class="col-xs-112 col-sm-3">
                                <img src="../image/province/<?php echo $image;?>" alt="<?php echo $image; ?>" style="width:100%;height:100%;border:2px solid black; border-radius:5px !important ;">
                            </div>
                        </div>
                    </div>
                    <br>
