    ...
    if(isset($_POST['btn_add'])){
        // $v_image = @$_FILES['txt_image'];
         //if($v_image["name"] != ""){
            ...
            $query_add = "INSERT INTO tbl_footer_text (
                    ft_text
                    ) 
                VALUES(
                    '$v_detail')";
    ...
    <div class="portlet-title">
     ...
     <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​រក្សាសិទិ្ធ</b></h3>
                <b style="font-size: 20px;">​​​​​COPY RIGHT</b><br><br>
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    <textarea style="height: 290px;" class="form-control detail" id="detail" name="txt_detail" placeholder="Enter Text" required="required" autocomplete="off"></textarea>
                                    <label style="color: white;font-size: 15px;">Detail
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                                    <span class="help-block">Enter Text Detail...</span>
                                </div>
                            </div>
                        </div>
                    </div>
