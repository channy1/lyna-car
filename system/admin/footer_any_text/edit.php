...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_footer_text SET ft_text='$v_detail' WHERE ft_id='$edit_id'";
...
<?php
    ...
    $query="SELECT * FROM tbl_footer_text WHERE ft_id='$edit_id'";
    $result = $connect->query($query);
    if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
            $description = $row["ft_text"];
        }
    }
    else{}
?>
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួលការ រក្សាសិទិ្ធ</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT COPY RIGHT</b><br><br>
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    <textarea style="height: 290px;" class="form-control detail" id="detail" name="txt_detail" placeholder="Enter Text" required="required" autocomplete="off"><?php echo ($description); ?></textarea>
                                    <label style="color: white;font-size: 15px;">Description
                                        <span class="required" aria-required="true">*</span>
                                    </label>
