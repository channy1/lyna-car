<?php 
    ...
    $v_sql = "SELECT * FROM tbl_footer_text";
...
<div class="portlet light bordered">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-user fa-fw"></i>COPYRIGHT CONTROL PANEL</h2>
        </div>
    </div>
    <div class="footer_menu"> 
       
        <a id="f_menu" href="../footer_img_footer/">Images Footer</a>
        <a id="f_menu" href="../footer_phone/">Phone Footer</a>
        <a id="f_menu" href="../footer_menu/">Menu</a>
        <a id="f_menu" class="active_ft" href="../footer_any_text/">Copyright</a>
    </div>
    <br><hr>
                ...
                <tbody>
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>";
                                echo "<td><a href='edit.php?edit_id=".$row["ft_id"]."'>".$row["ft_text"]."</a></td>";
