...
<?php
   if(isset($_POST["btn_add"])) { 
     ...
     $txt_vehicle_id1 = @$connect->real_escape_string($_POST['txt_vehicle_id1']);
     $txt_vehicle_id2 = @$connect->real_escape_string($_POST['txt_vehicle_id2']);
     $txt_vehicle_id3 = @$connect->real_escape_string($_POST['txt_vehicle_id3']);
     $txt_car_daily_day1 = @$connect->real_escape_string($_POST['txt_car_daily_day1']);
     $txt_car_daily_day2 = @$connect->real_escape_string($_POST['txt_car_daily_day2']);
     $txt_car_daily_day3 = @$connect->real_escape_string($_POST['txt_car_daily_day3']);
     $txt_car_extra_day1 = @$connect->real_escape_string($_POST['txt_car_extra_day1']);
     $txt_car_extra_day2 = @$connect->real_escape_string($_POST['txt_car_extra_day2']);
     $txt_car_extra_day3 = @$connect->real_escape_string($_POST['txt_car_extra_day3']);
     $txt_car_price_daly1 = @$connect->real_escape_string($_POST['txt_car_price_daly1']);
     $txt_car_price_daly2 = @$connect->real_escape_string($_POST['txt_car_price_daly2']);
     $txt_car_price_daly3 = @$connect->real_escape_string($_POST['txt_car_price_daly3']);
     $txt_car_price_extra1 = @$connect->real_escape_string($_POST['txt_car_price_extra1']);
     $txt_car_price_extra2 = @$connect->real_escape_string($_POST['txt_car_price_extra2']);
     $txt_car_price_extra3 = @$connect->real_escape_string($_POST['txt_car_price_extra3']);
     $txt_car_discount1 = @$connect->real_escape_string($_POST['txt_car_discount1']);
     $txt_car_discount2 = @$connect->real_escape_string($_POST['txt_car_discount2']);
     $txt_car_discount3 = @$connect->real_escape_string($_POST['txt_car_discount3']);
     $txt_car_vat1 = @$connect->real_escape_string($_POST['txt_car_vat1']);
     $txt_car_vat2 = @$connect->real_escape_string($_POST['txt_car_vat2']);
     $txt_car_vat3 = @$connect->real_escape_string($_POST['txt_car_vat3']);
     $txt_car_amount_daily1 = @$connect->real_escape_string($_POST['txt_car_amount_daily1']);
     $txt_car_amount_daily2 = @$connect->real_escape_string($_POST['txt_car_amount_daily2']);
     $txt_car_amount_daily3 = @$connect->real_escape_string($_POST['txt_car_amount_daily3']);
     $txt_car_amount_extra1 = @$connect->real_escape_string($_POST['txt_car_amount_extra1']);
     $txt_car_amount_extra2 = @$connect->real_escape_string($_POST['txt_car_amount_extra2']);
     $txt_car_amount_extra3 = @$connect->real_escape_string($_POST['txt_car_amount_extra3']);
     ...
     $query_add = "INSERT INTO tbl_quotation_admin(
            ...
            if($connect->query($query_add)){
              ...
              if($txt_vehicle_id1 !=""){
                 $sql_car1 = "INSERT INTO tbl_quotation_car(
                                q_id,
                                car_id,
                                car_daily_day,
                                car_extra_day,
                              ...
                              VALUES(
                                  ...
                                  '$txt_car_extra_day1',
                                  '$txt_car_price_daly1',
                                  '$txt_car_price_extra1',
                                  '$txt_car_discount1',
                                  '$txt_car_vat1',
                                  '$txt_car_amount_daily1',
                                  '$txt_car_amount_extra1'
                                  )";
                        if($connect->query($sql_car1)){
              ...
              if($txt_vehicle_id2 !=""){
                 $sql_car2 = "INSERT INTO tbl_quotation_car(
                                q_id,
                                car_id,
                                car_daily_day,
                                car_extra_day,
                              ...
                              VALUES(
                                  ...
                                  '$txt_car_extra_day2',
                                  '$txt_car_price_daly2',
                                  '$txt_car_price_extra2',
                                  '$txt_car_discount2',
                                  '$txt_car_vat2',
                                  '$txt_car_amount_daily2',
                                  '$txt_car_amount_extra2'
                                  )";
                        if($connect->query($sql_car2)){
              ...
              if($txt_vehicle_id3 !=""){
                 $sql_car3 = "INSERT INTO tbl_quotation_car(
                                q_id,
                                car_id,
                                car_daily_day,
                                car_extra_day,
                              ...
                              VALUES(
                                  ...
                                  '$txt_car_extra_day3',
                                  '$txt_car_price_daly3',
                                  '$txt_car_price_extra3',
                                  '$txt_car_discount3',
                                  '$txt_car_vat3',
                                  '$txt_car_amount_daily3',
                                  '$txt_car_amount_extra3'
                                  )";
                        if($connect->query($sql_car3)){
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms ?>
            <h2><i class="fa fa-plus-circle fa-fw"></i>CAR INFORMATION QUOTATION</h2>
        </div>
    </div>
    ...
    <div class="portlet-body">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Car Information Quotation Input Information</h3>
            </div>
                                      ...
                                      <div class="form-group">
                                            <label for="exampleFormControlInput1">1. Subject</label>
                                             <select name="txt_subject" class="form-control">
                                               <option value="1">Car Rental Service</option>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                                 <div class="panel panel_custom" style="padding:10px;">
                                  ...
                                  <table id="myTable" class=" table order_car">
                                          <thead>
                                              <tr>
                                                  <td>Vehicle</td>
                                                  <td>Daily Day</td>
                                       ...
                                       <input type="button" class="btn" id="add_car" value="Add Vehicle" />
  ...
  // car infor
    ...
    $("#add_car").on("click", function () {
      if(counter <=3) {
        ...
        cols += '<td><select name="txt_vehicle_id' + counter + '" class="form-control"><?php $ve_sql = $connect->query("SELECT * FROM tbl_vehicle_rantal ORDER BY ve_title ");while($row = mysqli_fetch_object($ve_sql)){?><option value="<?php echo $row->ve_id; ?>"><?php echo $row->ve_ref_no; ?></option><?php } ?></select></td>';
        cols += '<td><input type="text" id="txt_car_daily_day' + counter + '" name="txt_car_daily_day' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_extra_day' + counter + '" name="txt_car_extra_day' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_price_daly' + counter + '" name="txt_car_price_daly' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_price_extra' + counter + '" name="txt_car_price_extra' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_discount' + counter + '" name="txt_car_discount' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_vat' + counter + '" name="txt_car_vat' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_amount_daily' + counter + '" name="txt_car_amount_daily' + counter + '" class="form-control"></td>';
        cols += '<td><input type="text" id="txt_car_amount_extra' + counter + '" name="txt_car_amount_extra' + counter + '" class="form-control"></td>';

        cols += '<td><input type="button" class="btn_d_car btn btn-md btn-danger "  value="Delete"></td>';
        newRow.append(cols);
        $("table.order_car").append(newRow);
        counter++;
        }
         else {
            alert("limit 3");
    ...
    $("table.order_car").on("click", ".btn_d_car", function (event) {
        $(this).closest("tr").remove();       
        counter -= 1
    });

    function calulate_amount_car_daily(numbrt_loop) {
       var amount_car_daliy=0;
              var car_daily_day=$("#txt_car_daily_day"+numbrt_loop+"").val();
       
              var car_price_daly=$("#txt_car_price_daly"+numbrt_loop+"").val();
              var car_discount=$("#txt_car_discount"+numbrt_loop+"").val();
              var car_vat=$("#txt_car_vat"+numbrt_loop+"").val();
              var total_price_car_daily=car_daily_day * car_price_daly;
              var discount_daily=total_price_car_daily-(total_price_car_daily * car_discount)/100;
              var vat_daily=discount_daily+(discount_daily * car_vat)/100;
              amount_car_daliy=vat_daily;
              $("#txt_car_amount_daily"+numbrt_loop+"").val(amount_car_daliy);

    }

    function calulate_amount_car_extra(numbrt_loop) {
       var amount_car_extra=0;
              var car_extra_day=$("#txt_car_extra_day"+numbrt_loop+"").val();
              var car_price_extra=$("#txt_car_price_extra"+numbrt_loop+"").val();
              var car_discount=$("#txt_car_discount"+numbrt_loop+"").val();
              var car_vat=$("#txt_car_vat"+numbrt_loop+"").val();
              var total_price_car_extra=car_extra_day * car_price_extra;
              var discount_extra=total_price_car_extra-(total_price_car_extra * car_discount)/100;
              var vat_extra=discount_extra+(discount_extra * car_vat)/100;
              amount_car_extra=vat_extra;
              $("#txt_car_amount_extra"+numbrt_loop+"").val(amount_car_extra);

    }

    $("body").on("input", "#txt_car_daily_day1", function(){
      calulate_amount_car_daily(1);   
    });
    $("body").on("input", "#txt_car_daily_day2", function(){
      calulate_amount_car_daily(2);   
    });
    $("body").on("input", "#txt_car_daily_day3", function(){
      calulate_amount_car_daily(3);   
    });
    $("body").on("input", "#txt_car_price_daly1", function(){
      calulate_amount_car_daily(1);   
    });
    $("body").on("input", "#txt_car_price_daly2", function(){
      calulate_amount_car_daily(2);   
    });
    $("body").on("input", "#txt_car_price_daly3", function(){
      calulate_amount_car_daily(3);   
    });
    $("body").on("input", "#txt_car_discount1", function(){
      calulate_amount_car_daily(1);    
      calulate_amount_car_extra(1);
    });
    $("body").on("input", "#txt_car_discount2", function(){
      calulate_amount_car_daily(2);    
      calulate_amount_car_extra(2);
    });
    $("body").on("input", "#txt_car_discount3", function(){
      calulate_amount_car_daily(3);    
      calulate_amount_car_extra(3);
    });
    $("body").on("input", "#txt_car_vat1", function(){
      calulate_amount_car_daily(1); 
      calulate_amount_car_extra(1);   
    });
    $("body").on("input", "#txt_car_vat2", function(){
      calulate_amount_car_daily(2); 
      calulate_amount_car_extra(2);   
    });
     $("body").on("input", "#txt_car_vat3", function(){
      calulate_amount_car_daily(3); 
      calulate_amount_car_extra(3);   
    });


     $("body").on("input", "#txt_car_extra_day"+loop_car+"", function(){
      calulate_amount_car_daily();
      calulate_amount_car_extra(); 
    });
    $("body").on("input", "#txt_car_price_extra"+loop_car+"", function(){
      calulate_amount_car_daily();  
      calulate_amount_car_extra(); 
    });
