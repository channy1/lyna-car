                        ...
                        <table style="width:100%">
                            <tr>
                                <th style="padding:2px;font-weight: 100;">Grand Total:
                                    <label id="gr_total"style="margin-left:5px;color:blue;font-weight:900;font-size:14px;">&nbsp;&nbsp;$<span id="gr_total"></span></label>
                                </th>
                            </tr>
                          <?php
                          $get_id=$_GET['id'];
  ...
  <div style="width: 16px; border: 1px solid black;display:inline-block;text-align: center;color: blue;"><label>6</label></div>  
            ...
            <div class="row">
                ...
                <div class="panel-heading" style="width:100%;background: #fff !important;">
                    ...
                    <span style="color: blue;"><label style="font-size: 15px; font-weight: bold;">Driver Rental Service</label></span>
                    </div>
                </div>
            </div>
