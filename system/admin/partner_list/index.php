<?php 
    ...
    $v_sql = "SELECT * FROM tbl_users INNER JOIN tbl_user_position ON tbl_users.user_position=tbl_user_position.up_id where user_position ='3' GROUP BY user_id";
...
<div class="portlet light bordered">
   ...
   <div class="row">
   	 <div class="col-xs-12">
            <h2><i class="fa fa-user fa-fw"></i>PARTNER LIST CONTROL PANEL</h2>
        </div>
        <div class="col-md-8">
            ...
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline collapsed" id="sample_1" role="grid" aria-describedby="sample_1_info" >
                ...
                <tbody>
                    <?php 
                     ...
                     ?> 
                      <tr>
                        <td><a href="edit.php?edit_id=<?php echo $row["user_id"]; ?>"><?php echo $row["user_name"]; ?></a></td>
                        <td><?php 
