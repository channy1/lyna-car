...
<?php
   $edit_id = $_GET["edit_id"]; 
    ...
    while($row = $result->fetch_assoc()){
        ...
        $province_name = $row["ve_province_name"];
        ...
        $v_price_rent=$row['price_rent'];
        $v_province_id=$row['province_id'];
        $v_diposit=$row['refun_deposit'];
        }
    }
    else{}
?>
...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            ve_title='$v_title',
            ve_image='$new_name',
            ve_province_name='$province_name',
            ve_detail='$v_detail',
            ve_ref_no='$v_ref',
            ve_year='$v_year',
            ve_make='$v_make',
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                             ...
                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <span class="help-block">Enter Price...</span>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                                   <input type="text" value="<?php echo $v_price_rent; ?>" name="txt_price_rent" class="form-control" style="background-color:white;">
                                  </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <span class="help-block">Enter Price...</span>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                                   <input type="text" value="<?php echo $v_diposit; ?>"  name="txt_refun_deposit" class="form-control" style="background-color:white;">
                                  </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    ...
                                    value="<?php echo $row['pv_id']; ?>"><?php echo $row["pv_title"]; ?></option>
                                    <?php 
                                                }
                                            }
                                        ?>
