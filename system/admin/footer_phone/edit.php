...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_ft_phone SET ft_detail='$v_detail' WHERE ft_id='$edit_id'";
 ...
 ?>
<?php
    $query="SELECT * FROM tbl_ft_phone WHERE ft_id='$edit_id'";
...
<div class="portlet light bordered">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​កែសម្រួលលេខទូរស័ព្ទ</b></h3>
                <b style="font-size: 20px;">​​​​​EDIT PHONE FOOTER</b><br><br>
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                     <label style="color: white;font-size: 15px;" class="col-xs-12 col-md-3 col-sm-3 col-lg-2">Phone Number
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                                    <span class="help-block">Enter Phone Number...</span>
                                    <!-- <textarea style="height:290px;" class="form-control detail" id="detail" name="txt_detail" placeholder="Input Phone Number" required="required" autocomplete="off"><?php //echo ($des); ?></textarea> -->
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                                    <input type="text" class="form-control" name="txt_detail" placeholder="Enter Phone Number" value="<?php echo ($des); ?>"  required="required" autocomplete="off" style="background-color: white;">
                                   </div>
                                </div>
                            </div>
                        </div>
