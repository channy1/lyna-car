...
<div class="portlet light bordered">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-user fa-fw"></i>PHONE FOOTER CONTROL PANEL</h2>
        </div>
    </div>
    <div class="footer_menu"> 
        ...
        <a id="f_menu" class="active_ft" href="../footer_phone/">Phone Footer</a>
                ...
                <tbody>
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>";
                                echo "<td><a href='edit.php?edit_id=".$row["ft_id"]."'>".$row["ft_detail"]."</a></td>";
