    ...
    if(isset($_POST['btn_add'])){
        // $v_image = @$_FILES['txt_image'];
         //if($v_image["name"] != ""){
            ...
            $query_add = "INSERT INTO tbl_ft_phone (
                    ft_detail
                    ) 
                VALUES(
                    '$v_detail')";
...
<div class="portlet light bordered">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​​បញ្ចូលលេខទូរស័ព្ទ</b></h3>
                <b style="font-size: 20px;">​​​​​ADD PHONE FOOTER</b><br><br>
                        ...
                        <div class="row">
                            <!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="txt_title" placeholder="Enter Title" required="required" autocomplete="off">
                                    <label>Title
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <input type="text" class="form-control" name="txt_detail" placeholder="Enter Title" required="required" autocomplete="off" style="background-color: white;">
                                  </div>
                                </div>
                            </div>
                        </div>
