...
<html lag="en" class="dj_webkit dj_chrome dj_contentbox"><head>
    ...
    <table width="100%">
        <tbody><tr>
            <td colspan="2" valign="top" style="position: fixed;width: 100%; z-index: 1;top: 0;background:rgb(243, 241, 241) none repeat scroll 0% 0%;    border-bottom: 2px solid #D6D4D6;">
...
<div style="height:75px;width: 100%;display: none" class="head1">&nbsp;</div>
	<div style="width: 100%;float: left;font-size: 12px;">
		<div style="width: 30%;float: left;">
			<div style="width: 90%;border-bottom: 1px dotted black;text-align: center;float: left;margin: 0 auto">
								<strong style="font-size: 14px;color: red !important"><?php echo $row['user_introducer_id']; ?></strong>
							</div>
			<div style="width: 90%;float: left;text-align: center;">
				លេខយោងអ្នកបើកបរ<br>Driver ID N&deg;
			</div>
		</div>
		<div style="width: 40%;float: left;">
			<div style="width: 100%;float: left;">
				<strong style="font-family: 'Khmer OS Muol';font-size:18px">បង្កាន់ដៃ ទទួលប្រាក់កក់</strong>
				<strong style="font-family: 'Arial Black';font-size:18px;float: right;margin-top:-7px;">OFFICIAL RECEIPT RETURN</strong>
			</div>
		</div>
		<div style="width: 30%;float: left;">
	...
	<div style="width: 100%;float: left;font-size: 12px;margin-top: 5px;font-weight: bold;">
		<div style="width:36%; float: left;">
			<div style="width: 100%;border: 2px solid black;float: left;padding-left: 10px;">
				...
				<div style="width: 100%;float: left;margin-top: 0px;">
					...
					<div style="width: 80%;float: left;padding-left: 10px;font-weight: 100;">Ref. No. :&nbsp;<span style="color:#6C2A6E !important"><?php echo $row['user_introducer_id']; ?></span></div>
				</div>
				<div style="width: 100%;float: left;margin-top: 0px;">
					<div style="width: 10px; height: 10px;background:#1A790F !important;float: left;margin-top: 7px;"></div>
        ...
        <div style="width:4%;float: left;text-align:center;margin-top: 10%;"></div>
        <div style="width:8%;float: left;text-align:center;margin-top: 10%;color: #6C2A6E !important;">$<?php echo number_format($row['return_deposit'],2); ?></div>
