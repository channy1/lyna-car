         ...
         <div class="col-sm-12">
            ...
            <div style="width:100%;margin: 0 auto;border:0px solid #ccc;" id="div">
               ...
               <div style="width: 100%;text-align: center;font-size: 18px; font-weight: bold;">
                  <span>RICKSHAW RENTAL AGREEMENT</span>
               </div>
               <div style="width: 100%;">
                  <div style="width: 100%;float: left;">
                     <div style="width: 82%;float: left;">
                        <div style="width: 100%;">
                           <label >I. Information of Rickshaw's Owner. Hereinafter refers to as [Party A]</label>
                        </div>
               ...
               <span style="float: right;margin-top: -20px;margin-right: 39px;clear: both;font-size: 8px;"><?php echo $row['ag_ref_no']; ?></span>
                  ...
                  <div style="width: 100%;float: left;margin-top: -10px;">
                     <div style="width: 90%;float: left;">
                        <div style="width: 100%;">
                           <label>II. Information of Rickshaw's Renter. Hereinafter refers to as [Party B]</label>
                        </div>
                        <div style="width: 100%;padding-left: 15px;float: left;font-size: 11px;">
                          ...
                          <label style="width:30%;padding-left:10%;font-weight: bold;">Local Address Information</label><label style="width:30%;padding-left:10%; font-weight: bold;">International Address Information</label>
                         ...
                         <div>
                           <?php
                              if($row['user_gender']=="Male") {
                                 echo '<img src="male.png" style="width:100%;height: 110px;">';
                              }
                              else {
                                 echo '<img src="female.png" style="width:100%;height: 110px;">';
                              }
                           ?>
                  ...
                  <div style="width: 100%;float: left;margin-top: -5px;">
                     <div style="width: 100%;">
                        <label>IV. Rickshaw Information</label>
                     </div>
                     <?php
                      $id=$_GET['id'];
                      $v_sql_driver = "SELECT * FROM tbl_agreement
                       ...
                       if ($result->num_rows > 0) {
                        while($row_ric = $result->fetch_assoc()) {
                     ?>
                         <div style="width: 100%;float: left;font-size: 11px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width:50%;float: left;"><span style="color: blue !important;">: <?php echo $row_ric['ve_ref_no']; ?></span></div>
                        </div>
                        <div style="width:40%;float: left;">
                           <div style="width:30%;float: left;">
                              <p>Plate No</p>
                           </div>
                           <div class="data_support" style="width:60%;float: left;"><span style="color: blue !important;">: <?php echo $row_ric['ve_ref_no']; ?></span></div>
                        </div>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width:40%;float: left;"><span style="color: blue !important;">: <?php echo $row_ric['ve_year']; ?></span></div>
                        </div>
                        <div style="width:40%;float: left;">
                           <div style="width:30%;float: left;">
                              <p>Color</p>
                           </div>
                           <div class="data_support" style="width:60%;float: left;"><span style="color: blue !important;">: <?php echo $row_ric['ve_color']; ?></span></div>
                        </div>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width: 70%;float: left;"><span style="color: blue !important;">: <?php echo $row_ric['ve_make']; ?></span></div>
                        </div>
                  ...
                  <div style="width: 100%;float: left;margin-top:-2px;">
                     <div style="width: 100%;">
                        <label>V. Rental Period Information and Rental Rates (All the related payment must be paid in advance)</label>
                     </div>
                       <div style="width: 100%;float: left;font-size: 11pxpadding-left: 15px;">
                        <table border="1" style="border-collapse: collapse;width: 99%;font-size: 11px">
                           <tbody>
                              <tr>
                                 <td colspan="2" style="text-align: center;padding:6px;width: 25%; font-weight: bold;"><span>Rental Period Information</span></td>
                                 <td style="text-align: center;padding:6px;padding:6px;padding:6px;padding:6px;width: 25%;width: 25%; font-weight: bold;"><span>Items Description</span></td>
                                 <td style="text-align: center;padding:6px;padding:6px;padding:6px;width: 15%;width: 25%; font-weight: bold;"><span>Unit Price</span></td>
                                 <td style="text-align: center;padding:6px;padding:6px;width: 15%;width: 25%; font-weight: bold;"><span>Total Price</span></td>
                                 <td style="text-align: center;padding:6px;width: 20%;width: 25%; font-weight: bold;"><span>Remarks</span></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 ...
                                 <td style="text-align: right;padding-right: 10px;color: blue !important;width: 25%; font-weight: bold;">$<?php echo number_format($row['ag_amount_aft_d'],2); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <td style="padding:0px;border-left: 1px solid #fff;border-bottom: 1px solid #fff;" rowspan="2" colspan="2"></td>
                                 <td style="padding:0px;text-align: right;padding-right: 10px;">Amount After Discount and VAT</td>
                  ...
                  <div style="width: 100%;float: left;">
                     <div style="width: 100%;">
                        <label style="font-size:15px;">VII. Rickshaw Rental Agreement Signatories, Validation of Returning the Rickshaw and all the Related Items</label>
                     </div>
