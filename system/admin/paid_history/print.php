        ...
        <div class="row">
            ...
            <div style="width: 40%;float: left;">
                ...
                <span style="text-transform: uppercase;font-size: 11px;display: block;margin-left:27%;">PREPARED by:
                    <span style="border-bottom:1px solid black;font-weight: bold; margin-left: 4.5%;">
                     <?php  
                        echo $_GET['pre_by'];
                        ?>
                </span>
        ...
        <table class="table table-bordered" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-transform: uppercase;font-weight: normal;">Refund Deposit Record</th>
                    <th style="text-transform: uppercase;font-weight: normal;">LD Asst Fee</th>
                    <th style="text-transform: uppercase;font-weight: normal;">Paid Record</th>
                          ...
                          ?>
                                  ...
                                  <label style="width:80px;font-size: 9px;float: left;">
                                    ...
                                    <label style="width:60px;text-align: right;">
                                          $<?php
                                            if($row['refund_report']==""){
                                              $refun =0;
                                            }
                                            else {
                                              $refun=$row['refund_report'];
                                            }
                                            echo number_format($refun,2);
                                          ?>
                                    </label>
                                    </td>
                                    <td>
                                    <label style="width:60px;text-align: right;">
                                          $<?php
                                          if($row['ld_ass_report']==""){
                                              $ld =0;
                                            }
                                            else {
                                              $ld=$row['ld_ass_report'];
                                            }
                                            echo number_format($ld,2);
                                          ?>
                                    </label>
                                    </td>
