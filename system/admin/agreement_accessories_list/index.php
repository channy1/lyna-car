...
<div class="portlet light bordered">
   ...
   <div class="row">
        ...
        <div class="col-xs-12">
            <h2><i class="fa fa-user fa-fw"></i>ACCESSORIES LIST CONTROL PANEL</h2>
        </div>
    </div>
                     ...
                     ?> 
                      <tr>
                        ...
                        <td>  
                            ...
                            <a target="_blank" href="../../admin/return_receip_and_receip/acc_receip.php?id=<?php echo $row['ag_id']; ?>"><i class="fa fa-print fa-fw" aria-hidden="true"></i></a>
                            <a target="_blank" href="../../admin/return_receip_and_receip/acc_return_receip.php?id=<?php echo $row['ag_id']; ?>"><i class="fa fa-print fa-fw" aria-hidden="true"></i></a>
                        </td>
                       </tr>
                        <?php 
                           }
