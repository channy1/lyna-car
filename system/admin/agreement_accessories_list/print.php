...
<?php
  ...
  $v_sql = "SELECT * FROM tbl_agreement
              ...
              ON tbl_accessories_rental.ac_id=tbl_agreement.car_id
         ...
         <div class="col-sm-12">
            ...
            <div style="width:100%;margin: 0 auto;border:0px solid #ccc;" id="div">
               ...
               <div style="width: 100%;text-align: center;font-size: 18px; font-weight: bold;">
                  <span>ACCESSORIES RENTAL AGREEMENT</span>
               </div>
               <div style="width: 100%;">
               ...
               <span style="float: right;margin-top: -20px;margin-right: 39px;clear: both;font-size: 8px;"><?php echo $row['ag_ref_no']; ?></span>
                  ...
                  <div style="width: 100%;float: left;margin-top: -10px;">
                     ...
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                      ...
                      <div style="width: 100%;float: left;margin-top: -10px;">
                     <div style="width: 100%;">
                        <label>IV. Accessories Information</label>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div style="width:50%;float: left;"><span style="color: blue !important;">: <?php echo $row['ac_ref_no']; ?></span></div>
                        </div>
                        <div style="width:40%;float: left;">
                           <div style="width:30%;float: left;">
                              <p>Serial N&deg;</p>
                           </div>
                           <div style="width:60%;float: left;"><span style="color: blue !important;">: <?php echo $row['ac_title']; ?></span></div>
                        </div>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div style="width:40%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_year']; ?></span></div>
                        </div>
                        <div style="width:40%;float: left;">
                           <div style="width:30%;float: left;">
                              <p>Color</p>
                           </div>
                           <div style="width:60%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_color']; ?></span></div>
                        </div>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div style="width: 70%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_make']; ?></span></div>
                        </div>
                        ...
                        <table border="1" style="border-collapse: collapse;width: 99%;font-size: 11px">
                           <tbody>
                              <tr>
                                 ...
                                 <td style="text-align: center;padding:6px;padding:6px;padding:6px;padding:6px;width: 25%; font-weight: bold;"><span>Items Description</span></td>
                                 <td style="text-align: center;padding:6px;padding:6px;padding:6px;width: 15%; font-weight: bold;"><span>Unit Price</span></td>
                                 <td style="text-align: center;padding:6px;padding:6px;width: 15%; font-weight: bold;"><span>Total Price</span></td>
                                 <td style="text-align: center;padding:6px;width: 20%; font-weight: bold;"><span>Remarks</span></td>
                              </tr>
                              <tr>
                                 ...
                                 <td style="padding:1px;">1. Accessories Rental</td>
                  ...
                  <div style="width: 100%;float: left;margin-top: -2px;">
                     <div style="width: 100%;">
                        <label>VII. Vehicle Rental Agreement Signatories, Validation of Returning the Vehicle and all the Relate Items</label>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;">
                        ...
                        <div style="width:28%;float:left;border:1px solid #ccc;margin-left: 8px;height:90px;line-height: 14px;padding: 0.5%;">
                           ...
                           stay or use the accessories, the
