...
<?php
  ...
  $v_sql = "SELECT * FROM tbl_agreement
              ...
              ON tbl_vehicle_rantal.ve_id=tbl_agreement.car_id
         ...
         <div class="col-sm-12">
            ...
            <div style="width:100%;margin: 0 auto;border:0px solid #ccc;" id="div">
               ...
               <div style="width: 100%;text-align: center;font-size: 18px; font-weight: bold;">
                  <span>VEHICLE RENTAL AGREEMENT</span>
               </div>
               <div style="width: 100%;margin-top: -10px;">
                  <div style="width: 100%;float: left;">
                     <div style="width: 82%;float: left;">
                        <div style="width: 100%; margin-top: 9px;">
                           <label>I. Party A (Hereinafter refers to as the "Vehicle Owner")</label>
                        </div>
               ...
               <span style="float: right;margin-top: -20px;margin-right: 39px;clear: both;font-size: 8px;"><?php echo $row['ag_ref_no']; ?></span>
                  ...
                  <div style="width: 100%;float: left;margin-top: -10px;">
                     <div style="width: 90%;float: left;">
                        <div style="width: 100%; margin-top: 10px;">
                           <label>II. Party B (Hereinafter refers to as the "Vehicle Renter")</label>
                        </div>
                        <div style="width: 100%;padding-left: 15px;float: left;font-size: 11px">
                          ...
                          <label style="width:30%;padding-left:10%; font-weight: bold;">Local Address Information</label>
                          <label style="width:30%;padding-left:10%; font-weight: bold;">International Address Information</label>
                           ...
                           <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                              ...
                              <div style="width: 40%;float: left;">
                                 <div style="width: 30%;float: left;">
                                  ...
                                  <div class="data_support" style="width: 50%;float: left;"><span style="color: blue !important;">: <?php echo $row['user_email']; ?></span></div>
                              </div>
                           </div>
                           <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                              <div style="width: 30%;float: left;">
                  ...
                  <div style="width: 100%;float: left;margin-top: 2px;">
                     ...
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 25%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width:39%;float: left;"><span style="color: blue !important;">: <?php if($row['ag_id_card']=="1"){echo "Yes";}else {echo "No";} ?></span></div>
                        </div>
                        <div style="width: 24%;float: left;">
                           <div style="width:40%;float: left;">
                              <p>ID Card No</p>
                  ...
                  <div style="width: 100%;float: left;margin-top: 2px;">
                     <div style="width: 100%;">
                        <label>IV. Vehicle Information</label>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width:50%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_ref_no']; ?></span></div>
                        </div>
                        <div style="width:40%;float: left;">
                           <div style="width:30%;float: left;">
                              <p>Plate No</p>
                           </div>
                           <div class="data_support" style="width:60%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_ref_no']; ?></div>
                        </div>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width:40%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_year']; ?></span></div>
                        </div>
                        <div style="width:40%;float: left;">
                           <div style="width:30%;float: left;">
                              <p>Color</p>
                           </div>
                           <div class="data_support" style="width:60%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_color']; ?></span></div>
                        </div>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;margin-top: -10px;">
                        <div style="width: 50%;float: left;padding-left: 15px;">
                           ...
                           <div class="data_support" style="width: 70%;float: left;"><span style="color: blue !important;">: <?php echo $row['ve_make']; ?></span></div>
                        </div>
                        <!-- <div style="width: 50%;float: left;">
                           <div style="width:30%;float: left;">
                              <p style="margin-left:13px;">Model</p>
                           </div>
                           <div style="width:70%;float:right;"><span style="color: blue !important;">:<?php echo $row['ve_model']; ?></span></div>
                        </div> -->
                     </div>
                  </div>
                  <div style="width: 100%;float: left;margin-top: -5px;">
                     ...
                     <div style="width: 100%;float: left;font-size: 11pxpadding-left: 15px;">
                        <table border="1" style="border-collapse: collapse;width: 99%;font-size: 11px">
                           <tbody>
                              <tr>
                                 <th colspan="2" style="text-align: center;padding:6px;width: 25%"><span>Rental Period Information</span></th>
                                 <th style="text-align: center;padding:6px;padding:6px;padding:6px;padding:6px;width: 25%"><span>Items Description</span></th>
                                 <th style="text-align: center;padding:6px;padding:6px;padding:6px;width: 15%"><span>Unit Price</span></th>
                                 <th style="text-align: center;padding:6px;padding:6px;width: 15%"><span>Total Price</span></th>
                                 <th style="text-align: center;padding:6px;width: 20%"><span>Remarks</span></th>
                              </tr>
                              <tr>
                                 ...
                                 <td style="padding:1px;">1. Vehicle Rental</td>
                              ...
                              <tr>
                                 ...
                                 <td style="padding:1px;">4. Long Distance Assistance Fee</td>
                                 <td style="text-align: right;padding-right: 10px;color: blue !important;">$<?php echo number_format($row['ag_long_dast'],2); ?></td>
                                 <td style="text-align: right;padding-right: 10px;color: blue !important;">$<?php echo number_format($row['ag_long_dast'],2); ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 ...
                                 <td style="text-align: right;padding-right:7px;color: blue !important;"><?php if($row['ag_fuel']=="1"){echo "YES";}else {echo "NO";} ?></td>
                              ...
                              <tr>
                                 ...
                                 <td style="text-align: right;padding-right:7px;color: blue !important;"><?php if($row['ag_fuel_full_tank']=="1"){echo "YES";}else {echo "NO";} ?></td>
                              ...
                              <tr>
                                 ...
                                 <td colspan="2" style="text-align: right;padding-right: 10px;color: blue !important; font-weight: bold; font-size: 13px;">$<?php echo number_format($row['ag_total_net_pay'],2); ?></td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
                  ...
                  <div style="width: 100%;float: left;">
                     <div style="width: 100%;">
                        <label>VII. Vehicle Rental Agreement Signatories, Validation of Returning the Vehicle and all the Declared Items</label>
                     </div>
                     <div style="width: 100%;float: left;font-size: 11px;">
                        <div style="width:25%;float: left;border:1px solid #ccc;height:90px;line-height: 14px;padding: 0.5%;">
                           1. If the length of the agreement is more than
                           one month both the parties cannot break the
                           agreement earlier. In case, the Renter wishes
                           to break the agreement earlier, the deposit of
                        ...
                        <div style="width:18%;float: left;border:1px solid #ccc;margin-left: 8px;height:90px;line-height: 14px;padding: 0.5%;">
                           ...
                           turnover to back page(s) of the
                           agreement and read carefully from
                           articles <span style="color: blue !important"><?php echo $row['ag_articles_from']; ?></span> to <span style="color: blue !important"><?php echo $row['ag_articles_to']; ?></span> and the rest.
                        </div>
                        <div style="width: 20%;float: left;border:1px solid #ccc;margin-left: 8px;height:90px;line-height: 14px;padding: 0.5%;">
                           3. The above statement having
                           been agreed between the
                           signatories who have read
                           them declared to understand
                           all clauses.
                        </div>
                        <div style="width:28%;float:left;border:1px solid #ccc;margin-left: 8px;height:90px;line-height: 14px;padding: 0.5%;">
                           4. Note: If "<span style="color: blue !important">NO</span>" driver, you are
                           under the articles <span style="color: blue !important"><?php echo $row['ag_no_driver_from']; ?></span> to <span style="color: blue !important"><?php echo $row['ag_no_driver_to']; ?></span>
                           .If "<span style="color: blue !important">YES</span>", you are under articles
                           <span style="color: blue !important"><?php echo $row['ag_other_from']; ?></span> to <span style="color: blue !important"><?php echo $row['ag_other_to']; ?></span>.
                           <br>
                           &nbsp;
                        </div>
                     </div>
                  ...
                  <div style="width: 100%;float: left;margin-top:5px;">
                     <div style="width: 100%;padding-left: 15px;font-size: 12px;">
                        ...
                        <div style="width: 30%;font-weight: bold;text-align: center;float: left;">
                           Date: <?php echo date('l, F d, Y'); ?> <br><br><br><br><span style="font-weight: 100 !important;color:#ccc;">___________________</span><span style="color: blue !important;display: block;margin-top: -1px;"><?php echo $row['ag_name_owner_sign']; ?></span>
                        </div>
                     </div>
                  </div>
               </div>
