	...
	<div class="mainDetails">
		<div class="row">
           <div class="col-xs-12">
           	...
           	<p class="text-align:left;" style="font-size: 1.2em;"><?php echo $f_name; ?> <?php echo $l_name; ?></p>
           </div>
           <div class="col-md-8">
           	<ul>
           ...
           <div class="col-md-4" style="text-align:right;">
            <a target="_blank" href="cv_print.php?user_id=<?php echo $province_id; ?>" class="btn btn-success btn-xs">
              <i class="fa fa-print" aria-hidden="true"></i>
            </a>
           	<img src="../../img/img_partner/<?php echo $photo; ?>" style=" width: 120px; height: 120px; box-shadow: 0 0 1px 1px rgba(0,0,0,.1); border-radius: 10px;" alt="Profile Photo">
           </div>
        </div>
		<div class="clear"></div>
	</div>
