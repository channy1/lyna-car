                    ...
                    <div class="">
                        <table style="width:100%">
                          ...
                          $get_id=$_GET['id'];
                             ...
                             INNER JOIN tbl_air_port_booking
                             ON tbl_air_port_booking.user_id=tbl_users.user_id
                             WHERE tbl_air_port_booking.book_id='$get_id'";
  ...
  <div style="width: 16px; border: 1px solid black;display:inline-block;text-align: center;color: blue;"><label>6</label></div>
            ...
            <div class="row">
                ...
                <div class="panel-heading" style="width:100%;background: #fff !important;">
                    ...
                    <span style="color: blue;"><label style="font-size: 15px; font-weight: bold;">Airport Transfer Service</label></span>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <table style="border-collapse:collapse;font-size: 12px;margin-top:10px;float: left;" width="100%">
                  ...
                  <?php
                  $id=$_GET['id'];
                      $sql ="SELECT *,tbl_air_port_book_car.vat as vat_s FROM tbl_air_port_booking 
                                INNER JOIN tbl_users
                                ON tbl_air_port_booking.user_id=tbl_users.user_id
                                LEFT JOIN tbl_air_port_book_car
                                ON tbl_air_port_booking.book_id=tbl_air_port_book_car.booking_id
                                LEFT JOIN tbl_vehicle_rantal
                                ON tbl_vehicle_rantal.ve_id=tbl_air_port_book_car.car_id
                      WHERE tbl_air_port_booking.book_id='$id'";
