        ...
        ?>
            ...
            <a style="background-color: #a4509f; color: #a4509f; font-size: 11px;" href="#partner" class="list-group-item" data-toggle="collapse" data-parent="#main-menu"><font style="color:white !important;">PARTNER LIST</font><span class="caret"></span></a>
                ...
                <div class="collapse list-group-level1" id="partner">
                    ...
                    <a href="../airport_transfer_list/" class="list-group-item"><font class="tt zz">AIRPORT TRANSFER LIST</font></a>
                    <a href="../pickup_list/" class="list-group-item"><font class="tt zz">PICKUP DROP OFF LIST</font></a>
                    <a href="../city_tour_list/" class="list-group-item"><font class="tt zz">CITY TOUR LIST</font></a>
                </div>
    <?php } ?>
