    ...
    if(isset($_POST['btn_add'])){
        // $v_image = @$_FILES['txt_image'];
         //if($v_image["name"] != ""){
            ...
            $query_add = "INSERT INTO tbl_about (
                    about_title,
                    about_text,
                    about_text_kh
                    ) 
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">អំពីយើង</b></h3>
                <b style="font-size: 20px;">​​ADD ABOUT</b><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <input type="text" class="form-control" name="txt_title" placeholder="Enter Title" required="required" autocomplete="off" style="background-color: white;">
                                  	</div>
                                </div>
                                <!-- <div class="form-group form-md-line-input">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <textarea rows="5"  class="form-control detail" id="detail" name="txt_detail" placeholder="Repeat your password" required="required" autocomplete="off"></textarea>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <textarea rows="5"  class="form-control detail" id="details" name="txt_detail_kh" placeholder="Repeat your password" required="required" autocomplete="off"></textarea>
