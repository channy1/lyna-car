...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            $query_add = "UPDATE tbl_ft_latest_news SET ft_title='$v_title',ft_detail='$v_detail' WHERE ft_id='$edit_id'";
...
<?php
    ...
    $query="SELECT * FROM tbl_ft_latest_news WHERE ft_id='$edit_id'";
    ...
    <div class="portlet-title">
     ...
     <div class="row">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">​កែសម្រួលអ្វីដែលថ្មី </b></h3>
                <b style="font-size: 20px;">​​​​​EDIT LASTESR NEW</b><br><br>
