                    ...
                    <div class="">
                        <table style="width:100%">
                          ...
                          $get_id=$_GET['id'];
                             ...
                             INNER JOIN tbl_pickup_booking
                             ON tbl_pickup_booking.user_id=tbl_users.user_id
                             WHERE booking_id='$get_id'";
                          ...
                          ?>
                            ...
                            <tr>
                                <th style="padding:2px;font-weight: 100;">Q/I Ref. N&deg;:
                                    <label style="color:blue;">&nbsp;&nbsp;<?php echo $row['transaction_id']; ?></label>
                                </th>
                            </tr>
                            <tr>
  ...
  <div style="width: 16px; border: 1px solid black;display:inline-block;text-align: center;color: blue;"><label>6</label></div> 
                ...
                <div class="col-xs-5">
                    ...
                    <fieldset style="border: 1px solid #a4509f; border-radius: 9px;">
                        <legend style="border-bottom:none;margin-bottom:6px; background:none; text-align: left; margin-left: 20px; width:66px; color: #a4509f;">
                        ...
                        <ul style="line-height: 12px; margin-left: -20px;">
                          ...
                          <li style="list-style: none;">
                            <?php echo $ms_mr; ?> <label style="color:blue;"><?php echo $row['user_first_name']; ?><?php echo $row['user_first_name']; ?> <?php echo $row['user_last_name']; ?></label>
                          </li>
            ...
            <div class="row">
                ...
                <div class="panel-heading" style="width:100%;background: #fff !important;">
                    ...
                    <span style="color: blue;"><label style="font-size: 15px; font-weight: bold;">Pickup & Drop-off Service</label></span>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <table style="border-collapse:collapse;font-size: 12px;margin-top:10px;float: left;" width="100%">
                  ...
                  <?php
                  $id=$_GET['id'];
                      $sql ="SELECT tbl_pickup_book_car.vat as vat_s,tbl_pickup_book_car.discount as discount_s
                       ,tbl_users.*,tbl_vehicle_rantal.*,tbl_pickup_book_car.* FROM tbl_pickup_booking 
                                INNER JOIN tbl_users
                                ON tbl_pickup_booking.user_id=tbl_users.user_id
                                LEFT JOIN tbl_pickup_book_car
                                ON tbl_pickup_book_car.booking_id=tbl_pickup_booking.booking_id
                                LEFT JOIN tbl_vehicle_rantal
                                ON tbl_vehicle_rantal.ve_id=tbl_pickup_book_car.car_id
                      WHERE tbl_pickup_booking.booking_id='$id'";
                      ...
                      ?>
                        ...
                        <tr style="height:25px;border:1px!important">
                            ...
                            <td align="left" style="color:blue;padding-left:8px;width:48%;border:1px solid #000000">
                                <label>
                              Vehicle Rental (<?php echo $row['ve_title']; ?>)</label></td>
                            ...
                            <td align="right" style="color:blue;padding-right :3px;width:2%;border:1px solid #000000"><label>
                              <?php echo number_format(0,2); ?>%</label></td>
                            <td align="right" style="color:blue;padding-right:3px;width:2%;border:1px solid #000000">
                                <label>
                              <?php echo number_format($row['vat_s'],2); ?>%</label></td>

                            <td align="right" style="color:blue;background:#ffffff;border:1px solid #000000;" nowrap="">
                                <label>

                             $<?php
                            $total_price_dr=$row['price'] * 1;
                            $daily_discount_dr=$total_price_dr-($total_price_dr * 0)/100;
                            $daily_vat=$daily_discount_dr+($daily_discount_dr * $row['vat'])/100;
            ...
            <?php
            $total_pickup +=$total_price_dr_item;
                  }
               }
            ?>
