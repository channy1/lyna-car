...
?>
  ...
  <div style="width: 16px; border: 1px solid black;display:inline-block;text-align: center;color: blue;"><label>6</label></div>  
            ...
            <div class="panel panel-default">
                    ...
                    <tbody>
                       ...
                       <?php
                             ...
                             $total_car=0;
                                ...
                                while($row = $result->fetch_assoc()){
                                $ld=$row['ld_ass'];
                                $refun_deposit=$row['deposit_admin'];
                            ?>
                ...
                <?php 
                $total_acc += $price_item_accessory_extra+$price_item_accessory_daily;
              }} ?>
            ...
            ?>
                      ...
                      ?>
                        ...
                        <tr>
                            ...
                            <td align="right" style="padding-right:3px;color:blue;border:1px solid #000000;" nowrap=""><label>&nbsp;$<?php echo number_format($ld,2); ?></label></td>
                        </tr>

                        <tr>
                            <td align="left" colspan="3" style="border:1px solid #000000;" nowrap="">&nbsp;5. Refundable Deposit (RD):</td>
                            <td align="right" style="padding-right:3px;color:blue;border:1px solid #000000;" nowrap=""><label>&nbsp;$<?php echo number_format($refun_deposit,2); ?></label></td>
                        </tr>

                        <tr>
                            <td align="left" colspan="3" style="border:1px solid #000000;" nowrap="">&nbsp;6. Due Amount <span style="color:red;">**</span>:</td>
                            <td align="right" style="padding-right:3px;color:blue;background:white;border:1px solid #000000;" nowrap=""><label>&nbsp;$<?php echo number_format($ld+$refun_deposit,2); ?></label></td>
                        </tr>
                          <input type="hidden" id="grand_total" value="$<?php echo number_format($ld+$refun_deposit+$amount_pad,2); ?>">
                    </tbody>
                </table>
            </div>
