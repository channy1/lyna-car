...
<div class="container py-5" style="color: #a4509f; ">
   ...
   <div class="panel panel-default py-5">
      ...
      <div class="panel panel-body">
          ...
          <div class="col-md-6 col-sm-12"><div id="myBtn" class="form-group" style="text-align: center;">
      			<a class="form-control btn" style="width: 340px; margin: auto; color: white; background-color: #a4509f; padding:12px 0!important;" 
            href="./customer_login.php"><span><i class="fa fa-address-card"> </i> </span>Login as Customer</a>
      		</div></div>
           <div class="col-md-6 col-sm-12">
           <!-- ./register_customer_account.php -->
      		<div class="form-group" style="text-align: center;">	
	            <a class="form-control btn" style="width: 340px; margin: auto; color: white; background-color: #a4509f;padding:12px 0!important;" 
              href="./partner_login.php"><span><i class="fa fa-handshake-o"> </i> </span>Login as Partner
	            </a>
      		</div>
          </div>

          
          <div class="col-md-12 col-sm-12 text-center"><div id="myBtn" class="form-group" style="text-align: center;">
            <a class="form-control btn" style="width: 340px; margin: auto; color: white; background-color: #a4509f; padding:12px 0!important;" href="./admin_login.php"><span><i class="fa fa-address-card"> </i> </span>Login as Admin</a>
          </div></div>
